...
module.exports = function (app) { // module.exports opslutter her routesne
    ...
    app.get('/nyheder', function (req, res) {
        ...
        // Json array med nyheder
        var nyheder = [
            {
                "id": 1,
                "dato": "02/01/2014",
                "overskrift": "Slipsknuden online",
                "tekst": "Vi lancerer nu vores hjemmesiden med billeder af vores aller fineste slips."
            }, {
                "id": 2,
                "dato": "15/04/2013",
                "overskrift": "Slips!",
                "tekst": "Nye slips i vores sortiment."
            },
            {
                "id": 3,
                "dato": "7/03/2011",
                "overskrift": "Se her!",
                "tekst": "Nye modeslips er på vej til hjemmesiden."
            },
            {
                "id": 4,
                "dato": "30/08/2010",
                "overskrift": "Nu er de her!",
                "tekst": "Se vores nyeste slips under produkter!"
            }
        ]
    ...
    // om slipseknuden side
    app.get('/omslipseknuden', function (req, res) {

        // Json array med ansatte
        var omslips = [
            {
                "navn": "Anders Hansen",
                "stilling": "Direktør",
